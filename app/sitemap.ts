...
const ROUTES: {
  ...
  { path: "/alternativas", priority: 0.9, changeFreq: "weekly", lastModified: "2026-06-27" },
  { path: "/casas-de-apostas-confiaveis", priority: 0.88, changeFreq: "weekly", lastModified: "2026-06-27" },
  { path: "/casas-de-apostas-licenciadas", priority: 0.88, changeFreq: "weekly", lastModified: "2026-06-27" },
  { path: "/casa-de-apostas-com-pix", priority: 0.9, changeFreq: "weekly", lastModified: "2026-06-27" },
  { path: "/apostas-esportivas", priority: 0.88, changeFreq: "weekly", lastModified: "2026-06-27" },
  { path: "/palpites-futebol", priority: 0.85, changeFreq: "weekly", lastModified: "2026-06-27" },
  { path: "/apostas-brasileirao", priority: 0.85, changeFreq: "weekly", lastModified: "2026-06-27" },
  { path: "/apostas-copa-do-brasil", priority: 0.85, changeFreq: "weekly", lastModified: "2026-06-27" },
  { path: "/grupo-apostas", priority: 0.8, changeFreq: "monthly", lastModified: "2026-06-27" },
  ...COMPARISONS.map((c) => ({
    path: c.path,
    priority: 0.85,
